...
function loadSounds() {
	m_snd1 = new Media(snd1_snd, soundLoaded, soundErr);
	m_snd2 = new Media(snd2_snd, soundLoaded, soundErr);
	m_snd3 = new Media(snd3_snd, soundLoaded, soundErr);
	m_snd4 = new Media(snd4_snd, soundLoaded, soundErr);
}
